...
class StudentEdit extends Component {
  ...
  componentDidMount() {
    if (this.props.match.params.id !== "new") {
      ...
      this.props.actionsExam.findByStudent(this.props.match.params.id);
    }
  ...
  save(event) {
    ...
    if (this.state.student._id) {
      this.props.actionsStudent.updateStudent(this.state.student).then(data => {
      ...
      <div>
        ...
        <form className="myForm" onSubmit={this.save.bind(this)}>
          ...
          <FormControl fullWidth className="mb-20">
            <InputLabel htmlFor="_courses">Courses</InputLabel>
            <Select
              multiple
